This folder contains results based on some form of "classical" MD: an ionic pair potential is used. (Currently, there are no results for many-body potentials.)
