The dynamic structure factors of Yukawa potential
...
The data contains the DSF for only 0.0 < w < 3. If you need 
...
"sqw_fig.py" draws the DSF for a given kappa, Gamma, and q. Please see the file 
